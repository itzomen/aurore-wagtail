...
from aurore.apps.files.models import File
from aurore.apps.files.utils import (
    bytes_to_mib,
    file_generate_local_upload_url,
    file_generate_name,
    file_generate_upload_path,
)
from aurore.apps.integrations.aws.client import s3_generate_presigned_post
