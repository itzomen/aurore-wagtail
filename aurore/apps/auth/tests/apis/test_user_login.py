...
class UserSessionLoginTests(TestCase):
    def setUp(self):
        ...
        self.session_login_url = reverse("api:auth:session:login")
        self.session_logout_url = reverse("api:auth:session:logout")
        self.me_url = reverse("api:auth:me")

    def test_non_existing_user_cannot_login(self):
        self.assertEqual(0, User.objects.count())

        data = {"email": "test@domain.io", "password": "hacksoft"}
    ...
    def test_existing_user_can_login_and_access_apis(self):
        ...
        """
        credentials = {"email": "test@domain.io", "password": "password"}
...
class UserJwtLoginTests(TestCase):
    def setUp(self):
        ...
        self.jwt_login_url = reverse("api:auth:jwt:login")
        self.jwt_logout_url = reverse("api:auth:jwt:logout")
        self.me_url = reverse("api:auth:me")
