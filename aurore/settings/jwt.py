...
# Default to 7 days
JWT_EXPIRATION_DELTA_SECONDS = env(
    "JWT_EXPIRATION_DELTA_SECONDS", default=60 * 60 * 24 * 7
)
...
JWT_AUTH = {
    "JWT_GET_USER_SECRET_KEY": "aurore.apps.auth.services.auth_user_get_jwt_secret_key",
    "JWT_RESPONSE_PAYLOAD_HANDLER": "aurore.apps.auth.services.auth_jwt_response_payload_handler",
