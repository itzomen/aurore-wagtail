...
from aurore.apps.files.enums import FileUploadStorage, FileUploadStrategy
from aurore.env import BASE_DIR, env, env_to_enum
...
FILE_UPLOAD_STORAGE = env_to_enum(
    FileUploadStorage, env("FILE_UPLOAD_STORAGE", default="local")
)
